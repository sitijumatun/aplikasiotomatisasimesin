    ...
    <section class="content">
		...
		<div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			 <form role="form" class="center" method="post" action="apl_produktambah.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Produk</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Tambah produk" type="text" name="nama">
                </div>
              ...
              <!-- /.box-body -->
               ...
               <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-plus"></i>Tambah</button>
              ...
              <table class="table table-bordered">
                <tbody><tr>
                  ...
                  <th style="width: 200px"><center>Nama Produk</center></th>
                ...
                <tr>
                  <?php
					include "apl_koneksi.php";
					$query = "SELECT * FROM `apl_produk`";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
							echo "<td><center>".$data['Id_Produk']."</center></td>";
							echo "<td><center>".$data['Nama']."</center></td>";
							echo "<td><center>".$data['Status']."</center></td>";
									?>
							<td><?php echo"<center><a href='apl_produkupdate.php?Id_Produk=".$data['Id_Produk']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-edit'></i>Edit</button></a><a href='apl_produkdelete.php?Id_Produk=".$data['Id_Produk']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-trash'></i>Delete</button></a></center>"; ?></td>
							<?php echo "</tr>";
			}
	?>
                </tr>
