		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Update Mesin</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			
            <form role="form" class="center" method="post" action="apl_mesinupdate2.php" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group">
                  <label for="exampleInputEmail1">Id Mesin</label>
                  <input class="form-control"  id="exampleInputEmail1" placeholder="ID mesin" type="text" name="id" value="<?php echo $id?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Mesin</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama mesin" type="text" name="nama" value="<?php echo $nama?>">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Status</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Status" type="text" name="status" value="<?php echo $status?>" >
				  
                </div> 
				
				<button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-plus"></i>Update Mesin</button>		
              </div>
              <!-- /.box-body -->
