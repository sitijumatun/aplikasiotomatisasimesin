		...
		<div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Monitoring NG 3 Besar Desember 2017</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <ul class="nav nav-tabs pull-right ui-sortable-handle">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i>PLASTIC INJECTION</li>
            </ul>
            ...
            <!-- /.box-footer -->
              ...
              <table class="table table-bordered">
                <tbody><tr>
                  ...
                  <th style="width: 200px"><center>Jumlah NG</center></th>
				  
                </tr>
                <tr>
                  <td><center>ID</center></td>
				   <td><center>NAMA PRODUK</center></td>
				    <td><center>JUMLAH NG</center></td>
                </tr>
				<tr>
                  <td><center>1</center></td>
				   <td><center>HL LENS K93</center></td>
				    <td><center>2089</center></td>
                </tr>
				<tr>
                  <td><center>2</center></td>
				   <td><center>INNER LENS K93</center></td>
				    <td><center>1675</center></td>
                </tr>
				<tr>
                  <td><center>3</center></td>
				   <td><center>HOUSING K93</center></td>
