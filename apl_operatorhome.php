	...
	<div class="box box-solid bg-yellow">
            ...
            <div class="box-footer text-black">
			  ...
			  <table class="table table-bordered">
                <tbody><tr>
                  <th style="width: 200px"><center>No. Mesin</center></th>
                  <th style="width: 200px"><center>List Produk</center></th>
                 ...
                 <tr>
                          <th><select class="form-control" width="10px">
                            <?php
							include "apl_koneksi.php";
							$query2="select * from apl_mesin";
                          ...
                          <td><select class="form-control">
                            <?php
							include "apl_koneksi.php";
							$query3="select * from apl_produk";
							$hasil3=mysqli_query($conn, $query3);
							while ($data3=mysqli_fetch_array($hasil3))
							{
							
							echo "<option>".$data3['Nama']."</option>";
							}
							?>
                          </select></td>
                          <td><input class="form-control" type="password"></td>
                          <td><center><button type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-fw fa-gg-circle"></i> Jalankan</button></center></td>
                        </tr>
