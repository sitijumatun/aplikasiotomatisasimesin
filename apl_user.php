  ...
  <!-- Left side column. contains the logo and sidebar -->
   <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
		...
		<li class=" treeview"><a href="apl_monitoringngspesifik.php"><i class="fa fa-book"></i> <span>Monitoring NG Spesifik</span></a></li>
		  <li class="treeview">
		...
		<li class=" treeview"><a href="apl_kritiksaran.php"><i class="fa fa-book"></i> <span>Kritik dan Saran</span></a></li>
		...
		<div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 <form role="form" class="center" method="post" action="apl_usertambah.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Password" type="password" name="password">
                </div>
				<div class="form-group">
                  ...
                  <select class="form-control" name="posisi">
                    <?php
							include "apl_koneksi.php";
							$query2="select * from apl_role";
							$hasil2=mysqli_query($conn, $query2);
							while ($data2=mysqli_fetch_array($hasil2))
							{
							
							echo "<option>".$data2['Role']."</option>";
							}
							?>
                  </select>
                </div> 
              ...
              <!-- /.box-body -->
               ...
               <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-plus"></i>Tambah User</button>
              ...
              <table class="table table-bordered">
                <tbody><tr>
				  ...
				  <th style="width: 200px"><center>Posisi</center></th>
				  <th style="width: 200px"><center>Aksi</center></th>
                </tr>
                <tr>
                  <?php
					include "apl_koneksi.php";
					$query = "SELECT apl_User.Id_User as Id_User, apl_User.Username as Username, apl_User.Password as Password , apl_role.Role as Role FROM `apl_User` , apl_role WHERE apl_User.Id_Role = apl_role.Id_Role";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
							echo "<td><center>".$data['Id_User']."</center></td>";
							echo "<td><center>".$data['Username']."</center></td>";
							echo "<td><center>".$data['Password']."</center></td>";
							echo "<td><center>".$data['Role']."</center></td>";
									?>
							<td><?php echo"<center><a href='apl_userupdate.php?Id_User=".$data['Id_User']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-edit'></i>Edit</button></a><a href='apl_userdelete.php?Id_User=".$data['Id_User']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-trash'></i>Delete</button></a></center>"; ?></td>
							<?php echo "</tr>";
			}
	?>
                </tr>
