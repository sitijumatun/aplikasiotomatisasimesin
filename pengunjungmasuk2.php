		...
		<div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar Peserta Di dalam</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
                <tbody><tr>
                  <th style="width: 10px"><center>UID</center></th>
                ...
                <tr>
                  <?php
					include "koneksi2.php";
			$query = "SELECT * FROM peserta WHERE Status=1";
			$sql = mysqli_query($conn,$query);
			while($data = mysqli_fetch_array($sql)){
				echo "<tr>";
				echo "<td><center>".$data['RFID']."</center></td>";
				echo "<td><center>".$data['Nama']."</center></td>";
				echo "<td><center>".$data['Tanggal']."</center></td>";
				echo "<td><center><img src='images/".$data['Foto']."' width='100' height='100'></center></td>";
				echo "</tr>";
			}
	?>
                </tr>
