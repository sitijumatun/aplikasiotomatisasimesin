   ...
   <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu">
		...
		<li class="active treeview"><a href="apl_stok.php"><i class="fa fa-book"></i> <span>Stok</span></a></li>
		<li class="treeview">
		...
		<li><a href="#"><i class="fa fa-book"></i> <span>History</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
		...
		<div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data STOK PART 4 RODA</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table class="table table-bordered">
                <tbody><tr>
                  ...
                  <th style="width: 200px"><center>Nama Part</center></th>
                 
                  <th style="width: 200px"><center>1</center></th>
				  <th style="width: 200px"><center>2</center></th>
				  <th style="width: 200px"><center>3</center></th>
				  <th style="width: 200px"><center>4</center></th>
				  <th style="width: 200px"><center>5</center></th>
				  <th style="width: 200px"><center>6</center></th>
				  <th style="width: 200px"><center>7</center></th>
				  <th style="width: 200px"><center>8</center></th>
				  <th style="width: 200px"><center>9</center></th>
				  <th style="width: 200px"><center>10</center></th>
				   <th style="width: 200px"><center>TOTAL</center></th>
                </tr>
                <tr>
                  <?php
					include "apl_koneksi.php";
					$query = "SELECT * FROM `apl_stok`";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
							echo "<td><center>".$data['Id']."</center></td>";
							echo "<td><center>".$data['Nama_Part']."</center></td>";
							echo "<td><center>".$data['1']."</center></td>";
							echo "<td><center>".$data['2']."</center></td>";
							echo "<td><center>".$data['3']."</center></td>";
							echo "<td><center>".$data['4']."</center></td>";
							echo "<td><center>".$data['5']."</center></td>";
							echo "<td><center>".$data['6']."</center></td>";
							echo "<td><center>".$data['7']."</center></td>";
							echo "<td><center>".$data['8']."</center></td>";
							echo "<td><center>".$data['9']."</center></td>";
							echo "<td><center>".$data['10']."</center></td>";
							echo "<td><center>".$data['TOTAL']."</center></td>";
									?>
