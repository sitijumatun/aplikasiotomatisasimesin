		...
		<div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 <form role="form" class="center" method="post" action="apl_mesintambah.php" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <?php
					...
					while($data = mysqli_fetch_array($sql)){
							...
							echo "<td><center>".$data['Status']."</center></td>";
									?>
							<td><?php echo"<center><a href='apl_mesinupdate.php?Id_Mesin=".$data['Id_Mesin']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-edit'></i>Edit</button></a><a href='apl_mesindelete.php?Id_Mesin=".$data['Id_Mesin']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-trash'></i>Delete</button></a></center>"; ?></td>
							<?php echo "</tr>";
			}
	?>
                </tr>
