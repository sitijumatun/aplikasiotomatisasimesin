<?php
session_start();
if(!empty($_SESSION['username'])or !empty($_SESSION['password'])){header("location:coba.php");}
?>
...
$username2 = $_POST['username'];
$password2 = $_POST['password'];
$sql = mysqli_query($conn, "SELECT * FROM tbl_admin WHERE username='$username2' && password='$password2'");
...
// jika login salah //
echo "<script>eval(\"parent.location='index.php '\"); alert (' Maaf Login Gagal, Silahkan Isi Username dan Password Anda Dengan Benar');</script>";
//include("login.php");
