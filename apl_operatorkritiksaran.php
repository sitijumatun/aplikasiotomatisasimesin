   ...
   <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu">
		...
		<li class=" active treeview"><a href="apl_operatorkritiksaran.php"><i class="fa fa-book"></i> <span>Kritik dan Saran</span></a></li>
		<li class=" treeview">
		...
		<div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 <form role="form" class="center" method="post" action="apl_kritiksarantambah2.php" enctype="multipart/form-data">
              <div class="box-body">
