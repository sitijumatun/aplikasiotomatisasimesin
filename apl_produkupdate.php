...
$id= $_GET['Id_Produk']; 
$query = "SELECT * FROM `apl_produk` WHERE Id_Produk='".$id."'";
    ...
    <section class="content">
		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" class="center" method="post" action="apl_produkupdate2.php" enctype="multipart/form-data">
              <div class="box-body">
				...
				<button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-plus"></i>Update Produk</button>		
              </div>
              <!-- /.box-body -->
