...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
		...
		<li class="active treeview"><a href="apl_kritiksaran.php"><i class="fa fa-book"></i> <span>Kritik dan Saran</span></a></li>
		...
		<div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 <form role="form" class="center" method="post" action="apl_kritiksarantambah.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Username" type="text" name="nama" >
                </div>
				<div class="form-group">
                  <label>Kritik dan Saran</label>
                  <textarea name="kritik" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                </div>	
              </div>
              <!-- /.box-body -->	
               <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-plus"></i>Tambah Kritik dan Saran</button>
                ...
                <tr>
                  <?php
					...
					while($data = mysqli_fetch_array($sql)){
							...
							echo "<td>".$data['isi']."</td>";
									?>
							<td><?php echo"<center><a href='apl_kritiksarandelete.php?Id_KritikSaran=".$data['id']."'><button type='button' class='btn bg-navy margin'><i class='fa fa-fw fa-trash'></i>Delete</button></a></center>"; ?></td>
							<?php echo "</tr>";
			}
	?>
                </tr>
